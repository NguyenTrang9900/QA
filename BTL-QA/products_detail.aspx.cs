        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach (ProductList sp in arrProducts)
                {
                    ...
                    {
                        string type = sp.type;
                        if (type == "nam") { Banner_Productdetail.Text = "<div   class='nam'>&nbsp </div>"; }
                        else if (type == "nu") { Banner_Productdetail.Text = "<div class='nu'>&nbsp</div>"; }
                        else if (type == "phukien") { Banner_Productdetail.Text = "<div class='phukien'>&nbsp</div>"; }
